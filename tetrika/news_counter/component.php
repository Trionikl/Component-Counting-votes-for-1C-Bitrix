...
if( !Application::getConnection(\UserRating\MyTables\NenRatingVoteTable::getConnectionName()) -> isTableExists(
Base::getInstance('\UserRating\MyTables\NenRatingVoteTable') -> getDBTableName()) )
{
$base = Base::getInstance('\UserRating\MyTables\NenRatingVoteTable'); 
$base->createDbTable();
}	
...
//проверка таблицы на существование
if( !Application::getConnection(\UserRating\MyTables\NenRatingVoteTable::getConnectionName()) -> isTableExists(
Base::getInstance('\UserRating\MyTables\NenIpAddressTable') -> getDBTableName()) )
{
$base = Base::getInstance('\UserRating\MyTables\NenIpAddressTable'); 
$base->createDbTable();
}	
